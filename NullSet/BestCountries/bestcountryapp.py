...
# IMPORT DATA
# ===========================
conn = psycopg2.connect(user='khowlett',dbname='nullset')
cur = conn.cursor()
...
df = df.drop(columns=['unempbenefits','afp_totlabforce','afp_total','cgd_total',
                      'peacekeepers','suic_mortalityrate_pop','suic_mortalityrate_female',
                      'suic_mortalityrate_male'])
